...
public final class FilePlaylistParser implements ParsingLoadable.Parser<HlsPlaylist> {
...
//  private static final String key = "”\u0001y)ÜÊ’•CÃF¨@e¸\\";
  ...
  public static String getDynamicKey(){
    return "file:///data/user/0/com.lzx.musiclib/files/enc.key";
  }
  ...
  private static HlsMediaPlaylist parseMediaPlaylist(
      ...
      String baseUri)
      throws IOException {
    Log.e(TAG,"parseMediaPlaylist start");
...
//              fullSegmentEncryptionKeyUri = parseStringAttr(line, REGEX_URI, variableDefinitions);
              fullSegmentEncryptionKeyUri = key;
            } else {
        ...
        String segmentEncryptionIV =
            getSegmentEncryptionIV(
                segmentMediaSequence, key, fullSegmentEncryptionIV);
    ...
    Log.e(TAG,"parseMediaPlaylist done");
